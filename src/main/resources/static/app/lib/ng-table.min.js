    ...
    return b.value("ngTableDefaults", {
        ...
        var e = function (a) {
            ...
            this.data = [], this.parameters = function (b, c) {
                ...
                return a.isDefined(b) ? this.parameters({page: b}) : j.page
            }, this.total = function (b) {
                return a.isDefined(b) ? this.settings({total: b}) : k.total
            }, this.count = function (b) {
                return a.isDefined(b) ? this.parameters({count: b, page: 1}) : j.count
            }, this.filter = function (b) {
                return a.isDefined(b) ? this.parameters({filter: b, page: 1}) : j.filter
            }, this.sorting = function (b) {
                if (2 == arguments.length) {
                    var c = {};
                    return c[b] = arguments[1], this.parameters({sorting: c}), this
                }
                return a.isDefined(b) ? this.parameters({sorting: b}) : j.sorting
            ...
            var j = this.$params = {page: 1, count: 1, filter: {}, sorting: {}, group: {}, groupBy: null};
            a.extend(j, d.params);
            var k = {
                $scope: null,
                $loading: !1,
        ...
        b.$watch("params.$params", function (c, d) {
            ...
            a.forEach(c, function (c) {
                var d;
                return d = c.filterData(b, {$column: c}), d ? a.isObject(d) && a.isObject(d.promise) ? (delete c.filterData, d.promise.then(function (b) {
        ...
        var c = {
            "class": function () {
                ...
                return !1
            }, filterData: a.noop, headerTemplateURL: function () {
                return !1
                    ...
                    if (!f.attr("ignore-cell") || "true" !== f.attr("ignore-cell")) {
                        var g = function (a) {
                            ...
                            return e ? function (b, f) {
                                return c(e)(b, a.extend(f || {}, {$columns: d}))
                            } : void 0
        ...
        return {
            restrict: "A", priority: 1001, scope: !0, controller: "ngTableController", compile: function (d) {
                var e;
                return a.forEach(a.element(d.find("tr")), function (b) {
                    ...
                    var g = c(e.ngTableDynamic), h = b(g.columns)(a) || [];
